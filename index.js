  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateCard() {
      if (window.innerWidth < 768) {
        // MOBILVISNING - Skift kort med pile
        ...
        // DESKTOPVISNING - Alle kort ved siden af hinanden
        cardContainer.parentNode.innerHTML = `
          <button class="arrow"><img src="assets/left-pil.svg" alt="Left Arrow" /></button>
          ...
          <button class="arrow"><img src="assets/right-pil.svg" alt="Right Arrow" /></button>
        `;
        document.querySelectorAll(".arrow").forEach((arrow) => {
          arrow.style.display = "none"; // Skjul pile på desktop
        });
      }
    }
